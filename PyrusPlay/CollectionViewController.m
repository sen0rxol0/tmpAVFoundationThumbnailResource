...
- (void)fetchMediaManifest
{
    ...
    NSString *collectionSort;
    
    if ([@"Popular" isEqual:self.collectionTitle]) {
        collectionSort = @"seeders";
    } else if ([@"Frequent" isEqual:self.collectionTitle]) {
        collectionSort = @"downloads";
    } else if ([@"Newest" isEqual:self.collectionTitle]) {
        collectionSort = @"latest";
    } else if ([@"Ratings" isEqual:self.collectionTitle]) {
        collectionSort = @"rating";
    }
    
    NSURL* url = [NSURL URLWithString:[kMediaManifestURL stringByAppendingFormat:@"?sort=%@", collectionSort]];
